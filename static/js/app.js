...
(function () {
    ...
    function FileCtrl($scope, FileService, $timeout) {
        ...
        function search(wanted) {
            ...
            $scope.forwardStore = [];
            FileService.search($scope.path, wanted).then(function (result) {
                $scope.files = result;
            });
        }
